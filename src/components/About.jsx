...
const About = () => {
  ...
  return (
    <section
      id="about"
      className="min-h-screen relative py-12 md:py-16 pb-8 md:pb-12"
    >
      ...
      <div className="container  mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto md:bg-[#1a2544]/20 max-md:bg-none md:backdrop-blur-xl md:rounded-2xl min-md:border border-white/10 md:shadow-2xl">
