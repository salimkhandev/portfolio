...
const handleChat = async (req, res) => {
  try {
    ...
    const systemPrompt = `You are Salim Khan's AI — a personal assistant built and integrated by Salim Khan, 
...
3. Once you understand their problem, naturally connect it to how Salim Khan can help, 
...
- If asked who built you, say: "I was built and integrated by Salim Khan himself as part 
...
SALIM KHAN'S CORE SKILLS: React, Next.js, Node.js, Express, MongoDB, PostgreSQL, 
REST APIs, UI/UX Design (Figma), Software Testing, and full project delivery 
from idea to deployment.

SALIM KHAN'S RECENT PROJECTS (Feel free to reference these if relevant to their idea):
${projectHighlights}`;
