  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-2 sm:px-4 relative z-10">
        <div
          className="max-w-full sm:max-w-6xl mx-auto overflow-hidden"
          data-aos="fade-up"
        >
          <h2 className="text-4xl md:text-5xl font-bold text-center p-8 text-black">
            Projects
          </h2>
          ...
          {!loading && !error && projects.length === 0 && (
            <div className="flex justify-center items-center py-20">
              <div className="text-gray-600 text-xl">No projects found</div>
            </div>
          )}
